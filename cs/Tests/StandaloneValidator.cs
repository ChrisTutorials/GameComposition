...
namespace ArchitecturalValidation
{
    ...
    public class FrontEndNodeValidator
    {
        ...
        private static string GetAssemblyPath(string assemblyName)
        {
            ...
            {
                Path.Combine(baseDir, "..", "..", "..", "..", "..", "..", "demos", "grid_building_dev", "godot_cs", "addons", "GridPlacement", "Godot", "bin", "Debug", "net9.0", $"{assemblyName}.dll"),
                Path.Combine(baseDir, "..", "..", "..", "..", "..", "..", "demos", "grid_building_dev", "godot_cs", "addons", "GridPlacement", "Godot", "bin", "Release", "net9.0", $"{assemblyName}.dll"),
