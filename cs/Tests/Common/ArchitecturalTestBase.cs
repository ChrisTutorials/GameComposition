...
{
    /// <summary>
    /// Base class for architectural tests providing common patterns and setup.
    /// Eliminates duplication across architectural test classes.
    /// </summary>
    public abstract class ArchitecturalTestBase
    {
        /// <summary>
        /// Gets all relevant assemblies for architectural testing.
        /// </summary>
        protected static Assembly[] AllAssemblies => TestAssemblyHelper.GetAllRelevantAssemblies();

        /// <summary>
        /// Gets core assemblies only (excludes Godot assemblies).
        /// </summary>
        protected static Assembly[] CoreAssemblies => TestAssemblyHelper.GetCoreAssemblies();

        /// <summary>
        /// Gets assemblies including Godot assemblies for front-end testing.
        /// </summary>
        protected static Assembly[] AssembliesWithGodot => TestAssemblyHelper.GetAssembliesWithGodot();
        ...
        protected static object ForAssembly(Assembly assembly)
        {
        ...
        protected static IEnumerable<object> ForAllAssemblies()
        {
            return AllAssemblies.Select(ForAssembly);
        }
        ...
        protected static IEnumerable<object> ForCoreAssemblies()
        {
            return CoreAssemblies.Select(ForAssembly);
        }
        ...
        protected static IEnumerable<Type> FindTypesInAllAssemblies(Func<Type, bool> typePredicate)
        {
            return AllAssemblies.SelectMany(assembly => assembly.GetTypes().Where(typePredicate));
        }
        ...
        /// <param name="typePredicate">Predicate to match types</param>
        /// <returns>Collection of matching types</returns>
        protected static IEnumerable<Type> FindTypesInCoreAssemblies(Func<Type, bool> typePredicate)
        {
            return CoreAssemblies.SelectMany(assembly => assembly.GetTypes().Where(typePredicate));
        }
        ...
        /// <returns>Collection of matching types</returns>
        protected static IEnumerable<Type> FindTypesWithSuffix(string suffix, bool includeAbstract = false)
        {
        ...
        /// <param name="includeAbstract">Whether to include abstract types</param>
        /// <returns>Collection of matching types</returns>
        protected static IEnumerable<Type> FindTypesWithPrefix(string prefix, bool includeAbstract = false)
        {
            return FindTypesInAllAssemblies(type => 
        ...
        protected static IEnumerable<Type> FindTypesImplementing<TInterface>(bool includeAbstract = false)
        {
        ...
        protected static void ValidateNamespaceConvention(string namespacePrefix, Assembly[]? assemblies = null)
        {
            var targetAssemblies = assemblies ?? AllAssemblies;
        ...
        /// </summary>
        protected static void ValidateCoreAssembliesDoNotDependOnGodot()
        {
            var coreAssemblies = CoreAssemblies;
            var godotAssemblies = AssembliesWithGodot.Except(coreAssemblies).ToArray();
        ...
        protected static string GetAssemblyDisplayName(Assembly assembly)
        {
        ...
        protected static void AssertArchitecturalRule(bool condition, string message)
        {
